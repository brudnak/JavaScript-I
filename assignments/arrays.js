...
console.log(searchID(33))
console.log(searchID(19))
console.log(searchID(42))

// ==== Challenge 2 ====
// The dealer needs the information on the last car in their inventory.  What is the make and model of the last car in the inventory?  Log the make and model into the console.
// let lastCar = 0;
let lastCar = inventory[inventory.length - 1]
console.log(`The last vehicle in inventory is a ${lastCar.car_make} ${lastCar.car_model}`);
...
console.log(`There are ${oldCars.length} cars on the lot that are older than the year 2000.`)
